package cliphead.ljb.wmi.cliphead.act;
...
import cliphead.ljb.wmi.cliphead.R;
import cliphead.ljb.wmi.cliphead.utils.FileUtils;
import cliphead.ljb.wmi.cliphead.utils.ImageUtils;
import cliphead.ljb.wmi.cliphead.utils.UIUtils;
import cliphead.ljb.wmi.cliphead.view.ClipView;
...
public class ClipPictureActivity extends Activity implements OnClickListener{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		Bitmap srcBitmap = ImageUtils.getScaledBitmap(mImageUrl , UIUtils.getScreenWidth() , UIUtils.getScreenHeight());
